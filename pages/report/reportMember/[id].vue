    ...
    <div class="container" style="width: 60%;">
        ...
        <form @submit.prevent="submitReport">
            <div class="mb-3">
                ...
                <textarea id="reason" v-model="reason" rows="4" class="form-control" required />
            </div>
            ...
            <button type="submit" class="btn btn-primary" style="margin-right: 20px;">Submit Report</button>
